...
(define-findings
  ...
  (line-finding   spdx-license-header-finding  "A file has a missing or incorrect SPDX license identifier.")
  ...
  (line-finding   footer-line-finding          "A file lacks the canonical footer line.")
  (line-finding   project-identification-finding "A file lacks canonical project identification.")
