...
| 2026-04-13 | Slice 013 delivered: backlog #9 (documentation tools). 7 tools shipped (apropos-search, hyperspec-lookup, hyperspec-issue, hyperspec-issues, macroexpand-form, disassemble-symbol, compile-form). `apropos` renamed to `apropos-search` due to CL package lock. |
